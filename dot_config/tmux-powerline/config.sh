...
# The theme to use.
export TMUX_POWERLINE_THEME="my-system-theme"
...
# export TMUX_POWERLINE_SEG_CLAUDE_CODE_CREDENTIALS_FILE="/home/migue/.claude/.credentials.json"
...
# Center of my region (Venezuela) and search radius in km for the custom
# USGS-based earthquake segment.
export TMUX_POWERLINE_SEG_EARTHQUAKE_LAT="10.48"
export TMUX_POWERLINE_SEG_EARTHQUAKE_LON="-66.90"
export TMUX_POWERLINE_SEG_EARTHQUAKE_RADIUS_KM="500"
# }
...
export TMUX_POWERLINE_SEG_GITHUB_NOTIFICATIONS_TOKEN="${GITHUB_PERSONAL_ACCESS_TOKEN}"
...
# Default (also excludes docker/br/veth bridges and loopback):
export TMUX_POWERLINE_SEG_IFSTAT_INTERFACE_EXCLUDES="^u?tun[0-9]+$ ^docker[0-9]*$ ^br-[0-9a-f]+$ ^veth[0-9a-f]+$ ^lo$"
# }
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/migue/.mail/inbox/new"

## mbox
# Path to the mbox to check.
export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/migue"

## mailcheck
# Optional path to mailcheckrc
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/migue/.mailcheckrc"
# }
...
# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/migue/.now_playing.log"
...
export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/home/migue/.tmux/plugins//tmux-continuum"
# }
...
#   rm "/tmp/tmux-powerline_migue/tmux-powerline/weather_cache_data.txt"
...
# ping.sh {
# Host to ping for the network latency segment.
export TMUX_POWERLINE_SEG_PING_TARGET="1.1.1.1"
# }
